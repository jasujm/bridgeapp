...
<b-modal
    ...
    <p>
        Choose a name for yourself. There is no actual authentication, so anyone
        can claim any username at any time. The application just uses it to
        distinguish players from each other. The name will not be saved. All
        data collected by the server is pseudonymized.
    </p>
